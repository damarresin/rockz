...
<tr> 
	...
	<td width="95%" ><div align="center"><strong><font face="verdana" size="2" color="#000000"><h2>Forum</h2></font></strong></div></td>
	<td width="3%"></td>
</tr>
<tr>
	<td>&nbsp;</td>
	<td><table width="489" align="center">
		...
		<tr>
			<td bgcolor="#CCCCFFFFF" align="left">
			<?
			#menampilkan topik
		...
		<tr>
			...
			if ($get_pages>$entries)  //proses
			{
				...
				?>
				<a href="index.php?hal=view&page=9&id=<? echo ($pages-1); ?>&ID_topik=<? echo $_GET['ID_topik']; ?> " style="text-decoration:none"><font face="verdana" size="2" color="#009900"><? echo $pages; ?></font></a> 
				 <?
						$pages++;
				}
			}else{
			...
			if($jumlah){
				...
				?>
				<p align="center"><font color="#0066FF" face="verdana" size="2"><blink>Belum ada Tanggapan!!</blink></font></p>
				<?
			}
		...
		<tr>
			<td>
				<center>
				  <p><a href="home.php?page=10&ID_topik=<? echo $ID_topik; ?>&topik=<? echo $topik;?>" style="text-decoration:none ">
				      </a><a href="index.php?hal=forum" title="Kembali"><< Back</a>            <a href="index.php?hal=reply&ID_topik=<? echo $ID_topik; ?>&topik=<? echo $topik;?>" style="text-decoration:none ">KOMENT</a></p>
...
<tr> 
	<td align="right"></td>
	<td><div align="center"><strong><font face="verdana" size="3"></font></strong></div></td>
	<td></td>
</tr>
</table>
