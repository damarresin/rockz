...
<a href='index.php?hal=new' style='text-decoration:none' title='Membuat Topik Baru'><h3>Create Topic</h3></a></p>		
	...
	?>
		...
		if ($jumlah){
          ...
          <table width="483" height="89"   border="0" align="center">
			...
			?>
                <tr>
                  <td align="left"><b><a href="index.php?hal=view&ID_topik=<? echo $ID_topik;?>" style="text-decoration:none "> 
				  <img src="./img/forum.gif" border="0"><font face="verdana" size="2" color="#0033FF"><? echo $topik;?></font></a> </b><br>
